...
interface ERC4973UpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC4973Upgradeable extends BaseContract {
  ...
  interface: ERC4973UpgradeableInterface;
